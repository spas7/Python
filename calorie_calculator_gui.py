    ...
    if enter == "Calculate":
        ...
        try:
            ...
            tkinter.messagebox.showwarning(title="Error",
                                           message='Age, Height and Bodyweight fields must contain'
                                                   ' only whole numbers !')
        ...
        def goal_equation():
            if goal == "Maintain":
                ...
                result_label.config(text=f"Calculated Calories for Daily Intake : {calories_per_day:.2f} Kcal")
            elif goal == "Lose":
...
result_label = tkinter.Label(frame, text="Calculated Calories: ", bg="DeepSkyBlue2")
...
button.grid(row=4, column=0, sticky="news", padx=35, pady=10)
